/*
 * Tasks Route (TASK-02)
 * Purpose: Handles task extraction from conversation and task CRUD operations.
 * Atomic Scope: Only creates, reads, updates, or deletes tasks. Never modifies chat history.
 * Key Behaviors:
 *   - Extracts tasks from user messages using regex patterns
